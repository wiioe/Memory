...
public class ViewPagerActivity extends ActionBarActivity {
    ...
    static ArrayList<ContentItem> getSampleContent() {
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "p1.jpg"));
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "p2.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_3));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "p3.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "p4.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "p5.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "p6.jpg"));
